...
final class Class17 {
   ...
   static int anInt410;
   static int anInt411;
   static RSString aClass94_412 = Class3_Sub4.method108("Vous ne pouvez pas ajouter votre nom -9 votre liste d(Wamis)3", (byte)-119);
   static Class64 aClass64_413;
   static RSString aClass94_414 = Class3_Sub4.method108("Verbindung abgebrochen)3", (byte)-126);
   static RSString aClass94_415 = Class3_Sub4.method108("comp-Btence ", (byte)-118);
      ...
      try {
         if(var1.anInt2779 != 0) {
            ...
            if(var1.anInt2772 >= '\u8000') {
               ...
               Class140_Sub4_Sub1 var10 = Sprites.aClass140_Sub4_Sub1Array3269[var9];
               if(null != var10) {
