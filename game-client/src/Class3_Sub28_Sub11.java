...
final class Class3_Sub28_Sub11 extends Class3_Sub28 {
   ...
   static RSString aClass94_3637 = Class3_Sub4.method108(")4p=", (byte)-119);
   private static RSString aClass94_3638 = Class3_Sub4.method108("Loading fonts )2 ", (byte)-126);
   private static RSString aClass94_3639 = Class3_Sub4.method108(" is already on your friend list)3", (byte)-117);
   ...
   static final void method603(int var0, int var1, int var2, Class11 var3, boolean var4) {
      try {
         ...
         if(-1 != ~var3.aByte304) {
            if(~var3.aByte304 != -2) {
               if(~var3.aByte304 == -3) {
                  var3.anInt168 = var3.defWidth * var2 >> 14;
               } else if(var3.aByte304 == 3) {
                  if(~var3.anInt187 != -3) {
                     if(var3.anInt187 == 7) {
                        var3.anInt168 = 115 * var3.defWidth + var3.anInt285 * (-1 + var3.defWidth);
                     }
                  } else {
                     var3.anInt168 = var3.defWidth * 32 - -((var3.defWidth - 1) * var3.anInt285);
                  }
               }
            } else {
               var3.anInt168 = var2 + -var3.defWidth;
            }
         } else {
            var3.anInt168 = var3.defWidth;
         }

         if(-1 == ~var3.aByte241) {
            var3.anInt193 = var3.defHeight;
         } else if(var3.aByte241 == 1) {
            var3.anInt193 = -var3.defHeight + var0;
         } else if(~var3.aByte241 == -3) {
            var3.anInt193 = var0 * var3.defHeight >> 14;
         } else if(var3.aByte241 == 3) {
            if(~var3.anInt187 == -3) {
               var3.anInt193 = (var3.defHeight + -1) * var3.anInt290 + var3.defHeight * 32;
            } else if(~var3.anInt187 == -8) {
               var3.anInt193 = var3.defHeight * 12 + (-1 + var3.defHeight) * var3.anInt290;
            }
         }
   ...
   static final void method607(boolean var0) {
      try {
         ...
         RSInterface.aClass94_4 = Class48.aClass94_808;
