...
final class Class3_Sub14 extends Class3 {
   ...
   private final void method360(byte[] var1) {
      ...
      this.anInt2408 = var2.method748(-502942936);
      this.anInt2390 = var2.method748(-502942936);
      this.anInt2397 = var2.method748(-502942936);
      this.anInt2401 = var2.method748(-502942936);
      if(this.anInt2401 < 0) {
         this.anInt2401 = ~this.anInt2401;
         this.aBoolean2395 = true;
      }

      int var3 = var2.method748(-502942936);
   ...
   private static final boolean method362(Class153 var0) {
      if(!aBoolean2405) {
         byte[] var1 = var0.method2133(0, (byte)-122, 0);
         if(var1 == null) {
            return false;
         }
   ...
   static final Class3_Sub14 method363(Class153 var0, int var1, int var2) {
      if(!method362(var0)) {
