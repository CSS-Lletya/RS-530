...
final class Class78 {
   ...
   private Class3_Sub30 aClass3_Sub30_1113 = new Class3_Sub30((byte[])null);
   int[] anIntArray1114;
   ...
   final void method1372(long var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         this.aClass3_Sub30_1113.anInt2595 = this.anIntArray1118[var4];
         this.method1377(var4);
         this.anIntArray1115[var4] = this.aClass3_Sub30_1113.anInt2595;
      }

   }

   final boolean method1373() {
      return this.aClass3_Sub30_1113.aByteArray2590 != null;
   }
   ...
   final void method1376(int var1) {
      this.aClass3_Sub30_1113.anInt2595 = this.anIntArray1115[var1];
   }
   ...
   private final int method1378(int var1, int var2) {
      int var4;
      if(var2 == 255) {
         int var7 = this.aClass3_Sub30_1113.method803((byte)-60);
         var4 = this.aClass3_Sub30_1113.method741((byte)123);
         if(var7 == 47) {
            this.aClass3_Sub30_1113.anInt2595 += var4;
            return 1;
         } else if(var7 == 81) {
            int var5 = this.aClass3_Sub30_1113.method794((byte)87);
            var4 -= 3;
         ...
         var4 = var2;
         if(var3 >= 1) {
            var4 = var2 | this.aClass3_Sub30_1113.method803((byte)-69) << 8;
         }

         if(var3 >= 2) {
            var4 |= this.aClass3_Sub30_1113.method803((byte)-60) << 16;
         }
   ...
   private final int method1379(int var1) {
      byte var2 = this.aClass3_Sub30_1113.aByteArray2590[this.aClass3_Sub30_1113.anInt2595];
      int var5;
      if(var2 < 0) {
         var5 = var2 & 255;
         this.anIntArray1120[var1] = var5;
         ++this.aClass3_Sub30_1113.anInt2595;
      } else {
      ...
      if(var5 != 240 && var5 != 247) {
         ...
         if(var5 == 247 && var3 > 0) {
            int var4 = this.aClass3_Sub30_1113.aByteArray2590[this.aClass3_Sub30_1113.anInt2595] & 255;
         ...
         this.aClass3_Sub30_1113.anInt2595 += var3;
         return 0;
      }
   }

   final void method1380(byte[] var1) {
      this.aClass3_Sub30_1113.aByteArray2590 = var1;
      this.aClass3_Sub30_1113.anInt2595 = 10;
      int var2 = this.aClass3_Sub30_1113.method737(1);
      this.anInt1116 = this.aClass3_Sub30_1113.method737(1);
      this.anInt1121 = 500000;
      this.anIntArray1118 = new int[var2];

      int var3;
      int var5;
      for(var3 = 0; var3 < var2; this.aClass3_Sub30_1113.anInt2595 += var5) {
         int var4 = this.aClass3_Sub30_1113.method748(-502942936);
         var5 = this.aClass3_Sub30_1113.method748(-502942936);
         if(var4 == 1297379947) {
            this.anIntArray1118[var3] = this.aClass3_Sub30_1113.anInt2595;
            ++var3;
         }
      }
   ...
   final void method1381(int var1) {
      this.anIntArray1115[var1] = this.aClass3_Sub30_1113.anInt2595;
   }
   ...
   final void method1383() {
      this.aClass3_Sub30_1113.aByteArray2590 = null;
   ...
   final void method1384() {
      this.aClass3_Sub30_1113.anInt2595 = -1;
   }
