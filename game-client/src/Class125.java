   ...
   public Class125() {
      if(this.anInt2186 < 0) {
         if(Class138.aBoolean1818 && Class138.anInt1789 >= 2) {
            ...
            Class3_Sub30 var5 = new Class3_Sub30(262144);
            ...
            ByteBuffer var10 = ByteBuffer.allocateDirect(var5.anInt2595).order(ByteOrder.nativeOrder());
            var10.put(var5.aByteArray2590, 0, var5.anInt2595);
            var10.flip();
