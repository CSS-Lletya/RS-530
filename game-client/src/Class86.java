...
final class Class86 {
   ...
   int anInt1175;
   private static RSString aClass94_1176 = Class3_Sub4.method108("Loading wordpack )2 ", (byte)-120);
   int anInt1177;
   int anInt1178;
   static RSString aClass94_1179 = Class3_Sub4.method108("Veuillez patienter)3)3)3", (byte)-118);
   ...
   float aFloat1187;
   static RSString aClass94_1188 = Class3_Sub4.method108("::rebuild", (byte)-124);
   float aFloat1189;
   float aFloat1190;
   static int anInt1191;
   private static RSString aClass94_1192 = Class3_Sub4.method108("Examine", (byte)-121);
      ...
      try {
         if(var0 != -28922) {
            ...
            if(var2 != null) {
               ...
               var2.method697(Sprites.nameIconsSpriteArray, (int[])null);
