...
final class Class135 {
   ...
   static final Class135 method1811(Class153 var0, int var1, int var2) {
      byte[] var3 = var0.method2133(var1, (byte)-122, var2);
      return var3 == null?null:new Class135(new Class3_Sub30(var3));
   }
   ...
   private Class135(Class3_Sub30 var1) {
      for(int var2 = 0; var2 < 10; ++var2) {
         int var3 = var1.method803((byte)-48);
         if(var3 != 0) {
            --var1.anInt2595;
      ...
      this.anInt1769 = var1.method737(1);
      this.anInt1767 = var1.method737(1);
   }
