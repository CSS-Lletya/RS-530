...
final class Class37 {
   ...
   final void method1019() {
      Class3_Sub30 var1 = new Class3_Sub30(this.anInt655 * 4);
      Class3_Sub30 var2 = new Class3_Sub30(this.anInt653 * 16);
      int var3;
      if(Class138.aBoolean1790) {
         for(var3 = 0; var3 < this.anInt653; ++var3) {
            var2.method752((byte)-53, this.aByteArray654[var3]);
            var2.method752((byte)-7, this.aByteArray644[var3]);
            var2.method752((byte)-126, this.aByteArray650[var3]);
            var2.method752((byte)-13, 255);
         ...
         for(var3 = 0; var3 < this.anInt655; ++var3) {
            var1.method738(-122, this.anIntArray643[var3]);
         }
      } else {
         for(var3 = 0; var3 < this.anInt653; ++var3) {
            var2.method752((byte)-105, this.aByteArray654[var3]);
            var2.method752((byte)-103, this.aByteArray644[var3]);
            var2.method752((byte)-28, this.aByteArray650[var3]);
            var2.method752((byte)-111, 255);
      ...
      if(Class138.aBoolean1813) {
         ...
         ByteBuffer var4 = ByteBuffer.wrap(var2.aByteArray2590);
         this.aClass156_642.method2172(var4);
         this.aClass156_646 = new Class156();
         var4 = ByteBuffer.wrap(var1.aByteArray2590);
         this.aClass156_646.method2170(var4);
      } else {
         this.aByteBuffer647 = ByteBuffer.allocateDirect(var2.anInt2595);
         this.aByteBuffer647.put(var2.aByteArray2590);
         this.aByteBuffer647.flip();
         this.aByteBuffer652 = ByteBuffer.allocateDirect(var1.anInt2595);
         this.aByteBuffer652.put(var1.aByteArray2590);
