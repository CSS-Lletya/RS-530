...
final class Class3_Sub5 extends Class3 {
   ...
   int anInt2268;
   static RSString aClass94_2269 = Class3_Sub4.method108("lila:", (byte)-126);
   int anInt2270;
   int anInt2271;
   int anInt2272;
   int anInt2273;
   static RSString aClass94_2274 = Class3_Sub4.method108("Vous ne pouvez pas ajouter votre nom -9 votre liste noire)3", (byte)-128);
   static int anInt2275 = 1;
   static RSString aClass94_2276 = Class3_Sub4.method108("rot:", (byte)-128);
   int anInt2277;
   int anInt2278;
   int anInt2279;
   private static RSString aClass94_2280 = Class3_Sub4.method108("Starting 3d Library", (byte)-123);
   ...
   static final void method116(boolean var0, int var1) {
      try {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            if(!var0) {
               var4 = Sprites.aClass140_Sub4_Sub1Array3269[Class56.anIntArray887[var3]];
            } else {
