...
final class Class11 {
   ...
   int[] anIntArray207;
   int anInt208 = 0;
   static RSString aClass94_209 = Class3_Sub4.method108("event_opbase", (byte)-127);
   int anInt210 = 0;
   int[] anIntArray211;
   int anInt212;
   int anInt213;
   ...
   int anInt296;
   static RSString aClass94_297 = Class3_Sub4.method108("Nehmen", (byte)-118);
   ...
   static final RSString method856(boolean var0) {
      try {
         ...
         if(null != Class163_Sub2.aClass94_2996) {
            var2 = Class16.method903(new RSString[]{Class3_Sub28_Sub11.aClass94_3637, Class163_Sub2.aClass94_2996}, (byte)-64);
         }

         return Class16.method903(new RSString[]{Class30.aClass94_577, var1, Class3_Sub28_Sub7.aClass94_3601, Class72.method1298((byte)9, Class3_Sub20.anInt2485), Class151.aClass94_1932, Class72.method1298((byte)9, Class3_Sub26.anInt2554), var2, Class140_Sub3.aClass94_2735}, (byte)-61);
   ...
   final void method858(int var1, Class3_Sub30 var2) {
      try {
         ...
         this.defWidth = var2.method737(1);
         this.defHeight = var2.method737(1);
         this.aByte304 = 0;
         this.aByte241 = 0;
         this.aByte273 = 0;
         this.aByte162 = 0;
         ...
         if(~this.anInt187 == -3) {
            this.aByte241 = 3;
            this.anIntArray317 = new int[this.defWidth * this.defHeight];
            this.anIntArray254 = new int[this.defHeight * this.defWidth];
            this.aByte304 = 3;
            ...
            for(var10 = 0; var10 < 5; ++var10) {
               RSString var14 = var2.method776(true);
         ...
         if(7 == this.anInt187) {
            this.aByte241 = 3;
            this.aByte304 = 3;
            this.anIntArray317 = new int[this.defHeight * this.defWidth];
            this.anIntArray254 = new int[this.defWidth * this.defHeight];
            ...
            for(var7 = 0; var7 < 5; ++var7) {
               RSString var13 = var2.method776(true);
