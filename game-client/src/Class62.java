...
final class Class62 {
   ...
   int[] anIntArray945;
   static RSString aClass94_946 = Class3_Sub4.method108(")2", (byte)-128);
   int anInt947;
   private static RSString aClass94_948 = Class3_Sub4.method108("You can(Wt add yourself to your own friend list)3", (byte)-121);
   Class69 aClass69_949;
   static int anInt950;
   static RSString aClass94_951 = Class3_Sub4.method108("Interfaces charg-Bes", (byte)-122);
   static int anInt952;
   int[] anIntArray953;
   int[] anIntArray954;
   int[] anIntArray955;
