...
class Class164_Sub2 extends Class164 {
   ...
   static final int method2247(byte var0, int var1, Class11 var2) {
      try {
            ...
            try {
               ...
               while(true) {
                  ...
                  if(-5 == ~var8) {
                     var11 = var4[var6++] << 16;
                     var11 += var4[var6++];
                     var12 = Class7.method832((byte)124, var11);
                     var13 = var4[var6++];
                     if(-1 != var13 && (!Class38.method1023(var13, (byte)109).aBoolean779 || Class2.aBoolean66)) {
                  ...
                  if(6 == var8) {
                     var9 = Class48.anIntArray781[-1 + Class3_Sub20.anIntArray2480[var4[var6++]]];
                  }
                  ...
                  if(var8 == 10) {
                     var11 = var4[var6++] << 16;
                     var11 += var4[var6++];
                     var12 = Class7.method832((byte)115, var11);
                     var13 = var4[var6++];
                     if(~var13 != 0 && (!Class38.method1023(var13, (byte)88).aBoolean779 || Class2.aBoolean66)) {
                        for(var14 = 0; ~var12.anIntArray254.length < ~var14; ++var14) {
                  ...
                  if(-15 == ~var8) {
                     var11 = var4[var6++];
                     var9 = Class90.method1484(64835055, var11);
                  }
