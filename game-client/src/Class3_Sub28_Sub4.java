...
final class Class3_Sub28_Sub4 extends Class3_Sub28 {
   ...
   static RSString aClass94_3573 = Class3_Sub4.method108(" )2> <col=00ffff>", (byte)-124);
   static RSString aClass94_3574 = Class3_Sub4.method108("titlebg", (byte)-118);
  
   static RSString aClass94_3576 = Class3_Sub4.method108("name_icons", (byte)-126);
   static RSString aClass94_3577 = Class3_Sub4.method108(": ", (byte)-120);
   private static RSString aClass94_3578 = Class3_Sub4.method108("Loaded title screen", (byte)-126);
 ...
 static RSString aClass94_3575 = aClass94_3578;
         ...
         if(var1 != -1) {
            ...
            if(null == this.aClass94Array3571) {
               ...
               for(int var3 = 1; var3 < this.aClass94Array3571.length; ++var3) {
                  var2.method1533(RSInterface.aClass94_9, true);
   ...
   final RSString method555(int var1, Class3_Sub30 var2) {
      try {
         if(var1 != 28021) {
