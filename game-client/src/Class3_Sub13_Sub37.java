...
final class Class3_Sub13_Sub37 extends Class3_Sub13 {
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var3) {
            if(var1 == 0) {
               int var4 = var2.method803((byte)-68);
               if(-1 != ~var4) {
                  this.method345(var4, false);
               } else {
                  this.anIntArrayArray3438 = new int[var2.method803((byte)-126)][4];

                  for(int var5 = 0; ~this.anIntArrayArray3438.length < ~var5; ++var5) {
                     this.anIntArrayArray3438[var5][0] = var2.method737(1);
                     this.anIntArrayArray3438[var5][1] = var2.method803((byte)-81) << 4;
                     this.anIntArrayArray3438[var5][2] = var2.method803((byte)-63) << 4;
                     this.anIntArrayArray3438[var5][3] = var2.method803((byte)-28) << 4;
                  }
               }
            }
   ...
   static final void method347(boolean var0) {
      try {
         ...
         if(~Class44_Sub1.anInt2622 == -2 && -3140 >= ~var1 && -3200 <= ~var1 && var2 >= 3008 && 3062 >= var2) {
            Class44_Sub1.anInt2622 = 0;
         }
   ...
   final int[][] method166(int var1, int var2) {
      try {
         ...
         if(var1 != -1) {
            this.method157(-71, (Class3_Sub30)null, false);
         }
   ...
   static final Class168 method350(byte var0, int var1) {
      try {
         Class168 var2 = (Class168)Class163_Sub2_Sub1.aClass93_4015.method1526((long)var1, (byte)121);
         if(null == var2) {
            int var3 = 70 % ((var0 - 43) / 57);
            byte[] var4 = Class3_Sub28_Sub5.aClass153_3580.method2133(4, (byte)-122, var1);
            var2 = new Class168();
            if(var4 != null) {
               var2.method2274(24559, new Class3_Sub30(var4), var1);
            }

            Class163_Sub2_Sub1.aClass93_4015.method1515((byte)-109, var2, (long)var1);
            return var2;
         } else {
            return var2;
         }
