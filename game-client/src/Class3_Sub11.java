...
final class Class3_Sub11 extends Class3 {
   ...
   private static Class3_Sub30 aClass3_Sub30_2362;
   ...
   private static Class3_Sub30 aClass3_Sub30_2372;
   ...
   final void method148() {
      Class3_Sub30 var1 = new Class3_Sub30((this.aBoolean2347?40:36) * this.anInt2343);
      ...
      for(int var2 = 0; var2 < this.anInt2343; ++var2) {
         if(Class138.aBoolean1790) {
            ...
            var1.method738(-123, this.anIntArray2348[var2]);
            ...
            var1.method738(-124, this.anIntArray2348[var2]);
      ...
      if(Class138.aBoolean1813) {
         ByteBuffer var3 = ByteBuffer.wrap(var1.aByteArray2590, 0, var1.anInt2595);
         this.aClass156_2363 = new Class156();
         this.aClass156_2363.method2172(var3);
      } else {
         this.aByteBuffer2345 = ByteBuffer.allocateDirect(var1.anInt2595).order(ByteOrder.nativeOrder());
         this.aByteBuffer2345.put(var1.aByteArray2590, 0, var1.anInt2595);
   ...
   final void method149(Class3_Sub2[][][] var1, float var2, boolean var3) {
      if(aClass3_Sub30_2372 != null && aClass3_Sub30_2372.aByteArray2590.length >= this.anInt2359 * 4) {
         aClass3_Sub30_2372.anInt2595 = 0;
      } else {
         aClass3_Sub30_2372 = new Class3_Sub30(this.anInt2359 * 4);
      }

      if(aClass3_Sub30_2362 != null && aClass3_Sub30_2362.aByteArray2590.length >= this.anInt2356 * 4) {
         aClass3_Sub30_2362.anInt2595 = 0;
      } else {
         aClass3_Sub30_2362 = new Class3_Sub30(this.anInt2356 * 4);
      }
         ...
         for(var4 = 0; var4 < this.anInt2366; ++var4) {
            ...
            if(var5 != null && var5.aBoolean2222) {
               ...
               if(this.aBoolean2364) {
                  ...
                  if(var8 != null) {
                     for(var9 = 0; var9 < var8.length; ++var9) {
                        aClass3_Sub30_2362.method738(-124, var8[var9]);
                     }
                  }
               ...
               for(var12 = 1; var12 < var7.length - 1; ++var12) {
                  var6.method738(-128, var7[0]);
                  var6.method738(-123, var7[var12]);
                  var6.method738(-123, var7[var12 + 1]);
               }
            }
         }
      } else {
      ...
      if(aClass3_Sub30_2372.anInt2595 != 0 || aClass3_Sub30_2362.anInt2595 != 0) {
         ...
         if(aClass3_Sub30_2372.anInt2595 != 0) {
            if(aByteBuffer2368 != null && aByteBuffer2368.capacity() >= aClass3_Sub30_2372.anInt2595) {
               aByteBuffer2368.clear();
            } else {
               aByteBuffer2368 = ByteBuffer.allocateDirect(aClass3_Sub30_2372.anInt2595).order(ByteOrder.nativeOrder());
            }

            aByteBuffer2368.put(aClass3_Sub30_2372.aByteArray2590, 0, aClass3_Sub30_2372.anInt2595);
            aByteBuffer2368.flip();
            Class138.method1832(var2);
            var10.glDrawElements(4, aClass3_Sub30_2372.anInt2595 / 4, 5125, aByteBuffer2368);
         }

         if(aClass3_Sub30_2362.anInt2595 != 0) {
            if(aByteBuffer2361 != null && aByteBuffer2361.capacity() >= aClass3_Sub30_2362.anInt2595) {
               aByteBuffer2361.clear();
            } else {
               aByteBuffer2361 = ByteBuffer.allocateDirect(aClass3_Sub30_2362.anInt2595).order(ByteOrder.nativeOrder());
            }

            aByteBuffer2361.put(aClass3_Sub30_2362.aByteArray2590, 0, aClass3_Sub30_2362.anInt2595);
            aByteBuffer2361.flip();
            Class138.method1832(var2 - 100.0F);
            Class138.method1851();
            var10.glDrawElements(4, aClass3_Sub30_2362.anInt2595 / 4, 5125, aByteBuffer2361);
            Class138.method1830();
         }
