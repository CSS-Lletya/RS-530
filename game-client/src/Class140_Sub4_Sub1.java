...
final class Class140_Sub4_Sub1 extends Class140_Sub4 {
   ...
   int anInt3955 = -1;
   int anInt3956 = 0;
   static RSString aClass94_3957 = Class3_Sub4.method108("Gestionnaire de saisie charg-B", (byte)-117);
   private int anInt3958 = 0;
   static int[] anIntArray3959 = new int[2];
   int anInt3960 = 0;
   static RSString aClass94_3961 = Class3_Sub4.method108("Forced tweening ENABLED(Q", (byte)-118);
   Class52 aClass52_3962;
   int anInt3963 = -1;
   static RSString aClass94_3964 = Class3_Sub4.method108("_labels", (byte)-121);
   int anInt3965 = 0;
   int anInt3966 = -1;
   RSString aClass94_3967;
   boolean aBoolean3968 = false;
   int anInt3969 = 0;
   int anInt3970 = -1;
   static RSString aClass94_3971 = Class3_Sub4.method108("www)2wtqa", (byte)-125);
   int anInt3972 = -1;
   int anInt3973 = -1;
   int anInt3974 = 0;
               ...
               if(Class102.aClass140_Sub4_Sub1_2141 == this) {
                  for(var17 = RuntimeException_Sub1.aClass96Array2114.length + -1; -1 >= ~var17; --var17) {
                     ...
                     if(var27 != null && ~var27.anInt1355 != 0) {
                        ...
                        if(-11 == ~var27.anInt1360 && var27.anInt1359 >= 0 && ~Sprites.aClass140_Sub4_Sub1Array3269.length < ~var27.anInt1359) {
                           Class140_Sub4_Sub1 var28 = Sprites.aClass140_Sub4_Sub1Array3269[var27.anInt1359];
                           if(null != var28) {
   ...
   final RSString method1980(int var1) {
      try {
         RSString var2 = this.aClass94_3967;
         if(var1 != 0) {
            this.method1868(-63, 126, 58, -9, -74, -119, -45, -114, -62L, -76, (Class127_Sub1)null);
         }

         if(Class3_Sub30_Sub1.aClass94Array3802 != null) {
            var2 = Class16.method903(new RSString[]{Class3_Sub30_Sub1.aClass94Array3802[this.anInt3958], var2}, (byte)-92);
         }

         if(null != OutputStream_Sub1.aClass94Array45) {
            var2 = Class16.method903(new RSString[]{var2, OutputStream_Sub1.aClass94Array45[this.anInt3958]}, (byte)-128);
         }
