...
final class Class54 {
   ...
   static int anInt869;
   int[] anIntArray870;
   static RSString aClass94_871 = Class3_Sub4.method108("hint_headicons", (byte)-121);
   static int anInt872;
   RSString[] aClass94Array873;
   Class3_Sub28_Sub15 aClass3_Sub28_Sub15_874;
   static RSString aClass94_875 = Class3_Sub4.method108("Benutzen", (byte)-117);
   static int anInt876;
   int anInt877 = -1;
      ...
      try {
         ...
         if(!Class38_Sub1.aBoolean2615) {
            if(Class3_Sub13_Sub34.anInt3415 < 500) {
               ...
               Sprites.aLongArray3271[Class3_Sub13_Sub34.anInt3415] = var1;
