...
final class Class169 {
   ...
   final void method2281(int[][] var1, int var2, int var3) {
      Class3_Sub30 var4 = new Class3_Sub30(1620);
      ...
      if(Class138.aBoolean1813) {
         ByteBuffer var9 = ByteBuffer.wrap(var4.aByteArray2590, 0, var4.anInt2595);
         this.aClass156_2110 = new Class156();
         this.aClass156_2110.method2172(var9);
      } else {
         this.aByteBuffer2109 = ByteBuffer.allocateDirect(var4.anInt2595).order(ByteOrder.nativeOrder());
         this.aByteBuffer2109.put(var4.aByteArray2590, 0, var4.anInt2595);
         this.aByteBuffer2109.flip();
      }

      Class3_Sub30 var8 = new Class3_Sub30(1536);

      for(var6 = 0; var6 < 8; ++var6) {
         for(int var7 = 0; var7 < 8; ++var7) {
            if(Class138.aBoolean1790) {
               var8.method738(-125, var7 + (var6 + 1) * 9);
               var8.method738(-128, var7 + var6 * 9);
               var8.method738(-128, var7 + 1 + var6 * 9);
               var8.method738(-120, var7 + (var6 + 1) * 9);
               var8.method738(-127, var7 + 1 + var6 * 9);
               var8.method738(-122, var7 + 1 + (var6 + 1) * 9);
            } else {
      ...
      if(Class138.aBoolean1813) {
         ByteBuffer var10 = ByteBuffer.wrap(var8.aByteArray2590, 0, var8.anInt2595);
         this.aClass156_2105 = new Class156();
         this.aClass156_2105.method2170(var10);
      } else {
         this.aByteBuffer2107 = ByteBuffer.allocateDirect(var8.anInt2595).order(ByteOrder.nativeOrder());
         this.aByteBuffer2107.put(var8.aByteArray2590, 0, var8.anInt2595);
