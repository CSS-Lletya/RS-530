...
final class Class32 {
   ...
   static RSString aClass94_591 = Class3_Sub4.method108("Lade Benutzeroberfl-=che )2 ", (byte)-117);
   static RSString aClass94_592 = Class3_Sub4.method108("<img=0>", (byte)-119);
   static RSString aClass94_593 = Class3_Sub4.method108("Utiliser", (byte)-124);


   static final RSString method992(Class3_Sub30 var0, int var1) {
      try {
         if(var1 != 29488) {
            anInt590 = 22;
         }
