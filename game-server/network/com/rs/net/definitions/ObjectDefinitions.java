package com.rs.net.definitions;

import com.rs.cache.MemoryArchive;
import com.rs.net.ByteStream;
import com.rs.net.ByteStreamExt;
...
public final class ObjectDefinitions {
	...
	public static ObjectDefinitions objectOf(int i) {
		...
		ObjectDefinitions class46 = cache[cacheIndex];
		class46.type = i;
		class46.setDefaults();
	...
	public static void loadConfig() {
		...
		System.out.println("loaded obf def");
	}
	...
	public int anInt781;
	private static ObjectDefinitions[] cache;
