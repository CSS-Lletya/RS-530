...
import com.rs.GameEngine;
import com.rs.content.ClanManager;
import com.rs.content.ShopManager;
import com.rs.entity.actor.Actor;
import com.rs.entity.actor.attribute.Attribute;
import com.rs.entity.actor.item.GroundItemManager;
import com.rs.entity.actor.npc.NPC;
import com.rs.entity.actor.player.Player;
import com.rs.entity.actor.player.task.AreaTask;
import com.rs.entity.actor.player.task.CoordinateTask;
import com.rs.entity.actor.player.task.Task;
import com.rs.entity.actor.player.task.TaskManager;
import com.rs.entity.actor.player.task.impl.LevelChangeTask;
import com.rs.entity.actor.player.task.impl.RestoreSpecialTask;
import com.rs.entity.actor.player.task.impl.RunEnergyTask;
import com.rs.entity.actor.player.task.impl.SkullCycleTask;
import com.rs.net.Constants;
import com.rs.net.entity.EntityList;
import com.rs.net.entity.NPCUpdate;
import com.rs.net.entity.PlayerUpdate;
...
//		}
		...
		players.remove(p);
		GameEngine.getLoader().getWorkerThread().savePlayer(p);
	...
	public int[] getMapData(int region) {
		return GameEngine.getLoader().getMapData(region);
	}
