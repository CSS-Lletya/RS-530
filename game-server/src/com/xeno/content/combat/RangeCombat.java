...
import com.xeno.content.events.PoisonEvent;
...
public class RangeCombat {
	...
	public static void rangeCombatLoop(final Entity killer, final Entity target) {
		...
		int damage1 = Misc.random(getDamage((Player) killer, target, usingBow, usingArrows));
		int damage2 = usingBow == DARK_BOW ? Misc.random(getDamage((Player) killer, target, usingBow, usingArrows)) : 0;
