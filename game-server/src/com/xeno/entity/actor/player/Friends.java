...
public class Friends {
	...
	public void addFriend(long name) {
		...
		if(friends.contains((Long) name)) {
			player.getActionSender().sendMessage(Utility.formatPlayerNameForDisplay(Utility.longToPlayerName(name)) + " is already on your friends list.");
			return;
		}
		for(Player p : World.getInstance().getPlayerList()) {
			if(p != null) {
	...
	public void addIgnore(long name) {
		...
		if(ignores.contains((Long) name)) {
			player.getActionSender().sendMessage(Utility.formatPlayerNameForDisplay(Utility.longToPlayerName(name)) + " is already on your ignore list.");
			return;
		}
	...
	public void sendMessage(long name, String text, byte[] packed) {
		...
		player.getActionSender().sendMessage(Utility.formatPlayerNameForDisplay(Utility.longToPlayerName(name)) + " is currently unavailable.");
	}
