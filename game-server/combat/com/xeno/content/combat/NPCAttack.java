...
public class NPCAttack {
	...
	public static boolean npcAttack(NPC npc, Entity target) {
		if (npcHasAttack(npc)) {
	...
	private static boolean npcHasAttack(NPC npc) {
	...
	private static final int DHAROK = 2026, AHRIM = 2025, TORAG = 2029, KARIL = 2028, VERAC = 2030, GUTHAN = 2027;
}
